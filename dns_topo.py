...
"""
dns_topology.py
Simulates a 4-host Mininet topology, adds NAT for Internet access,
performs DNS resolution tests from URL files, saves per-URL results
to the same folder, and prints only the final summary table.
"""
